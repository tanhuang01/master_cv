...
public class _01_FlipView extends View {
    ...
    public _01_FlipView(Context context) {
        super(context);
    }

    public _01_FlipView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public _01_FlipView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
